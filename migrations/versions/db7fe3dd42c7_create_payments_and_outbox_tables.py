...
def upgrade() -> None:
    ...
    sa.Column('status', sa.Enum('pending', 'processing', 'published', 'failed', name='outbox_status_enum'), nullable=False),
    ...
    op.create_index('ix_outbox_status_next_attempt_at', 'outbox', ['status', 'next_attempt_at'], unique=False)
